 ...
 * of windows */
gboolean on_prot_info_delete_event(GtkWidget *prot_info, GdkEvent *evt,
                                   gpointer user_data)
{
  GList *item = NULL;
...
void update_prot_info_windows(void)
{
...
static gint protocols_table_compare(GtkTreeModel *gs, GtkTreeIter *a, GtkTreeIter *b,
                                    gpointer userdata)
{
  gint ret = 0;
  gdouble t1, t2;
...
gboolean on_delete_protocol_window(GtkWidget *wdg, GdkEvent *evt, gpointer ud)
{
  toggle_protocols_window();
...
gboolean on_prot_list_select_row(GtkTreeView *gv, gboolean arg1, gpointer user_data)
{
 ...
 * It has to free memory and delete the window from the list
 * of windows */
gboolean on_node_info_delete_event(GtkWidget *node_info, GdkEvent *evt,
                                   gpointer user_data)
{
...
void update_stats_info_windows(void)
{
  GList *list_item;
  GtkWidget *window;
  capstatus_t status;
...
static void stats_info_update(GtkWidget *window, const traffic_stats_t *stats)
{
  if (!stats) {
...
static void update_node_protocols_window(GtkWidget *window)
{
 ...
 ***************************************************************************/
/* Comparison function used to compare stats_info_windows */
static gint link_info_window_compare(gconstpointer a, gconstpointer b)
{
